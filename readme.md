...
- Useful for categorizing tags, logs, people, dates, items, etc. For pages that use many times. This is useful for things like the right sidebar content page or others.
